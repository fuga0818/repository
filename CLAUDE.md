...
When building any frontend interface (web components, pages, applications, dashboards, React components, HTML/CSS layouts, or any web UI), always apply the following design principles.
